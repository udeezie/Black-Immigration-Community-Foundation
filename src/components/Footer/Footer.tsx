          ...
          <div className="footer__left">
            <div className="footer__cta">
              ...
              <div className="footer__actions">
                ...
                <Link to="/services" className="footer__btn footer__btn--ghost">
            ...
            <address className="footer__address">
              ...
              <a href="mailto:secretary@bicf.ca">
            ...
            <div className="footer__social-section">
              ...
              <ul className="footer__social-list">
                <li className="footer__social-item">
                  <a aria-label="Instagram" data-social="instagram">
                ...
                <li className="footer__social-item">
                  <a aria-label="Facebook" data-social="facebook">
                    <div className="footer__social-fill" />
                ...
                <li className="footer__social-item">
                  <a aria-label="LinkedIn" data-social="linkedin">
                    <div className="footer__social-fill" />
                    <svg viewBox="0 0 24 24" fill="currentColor" width="17" height="17">
      ...
      <div className="footer__bar">
        <div className="footer__bar-inner">
          ...
          <div className="footer__legal">
            <span>{t({ en: 'Privacy Policy', fr: 'Confidentialité' })}</span>
            <span>{t({ en: 'Terms of Use', fr: 'Conditions d\'Utilisation' })}</span>
            <span>{t({ en: 'Accessibility', fr: 'Accessibilité' })}</span>
          </div>
        </div>
      </div>
